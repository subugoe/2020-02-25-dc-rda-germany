...
venue: "RDA Germany Conference 2020"        # brief name of host site without address (e.g., "Euphoric State University")
address: "GFZ, Telegrafenberg, 14473 Potsdam, Germany"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "52.38220, 13.06430"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Feb 25-26, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "14:00 pm - 12:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2020-02-25      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2020-02-26        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Daniel Bangert", "Claudia Engelhardt", "Timo Gnadt"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Claudio Leone"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2020-02-25-dc-rda-germany            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
http://pad.carpentries.org/2019-11-12-ugoe-carpentries
